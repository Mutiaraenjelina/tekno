        ...
        <div class="">
            <nav>
                <ol class="breadcrumb breadcrumb-example1 mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Daftar Tagihan Sewa</li>
                </ol>
            </nav>
        </div>
    </div>
                ...
                <table id="responsiveDataTable" class="table table-bordered text-nowrap w-100">
                    <thead>
                        <tr>
                            ...
                            <th>Jangka Waktu</th>
                            <th>Pembayaran Per Tahun</th>
                            <th>Status</th>
                            <th class="text-center" style="width: 10px;">Aksi</th>
                        </tr>
                    </thead>
                    <tbody>
                        @if (isset($tagihanSewa) && count($tagihanSewa) > 0)
                            @foreach ($tagihanSewa as $tS)
                                <tr>
                                    <td>
                                        <div class="d-flex">
                                            <div class="ms-2">
