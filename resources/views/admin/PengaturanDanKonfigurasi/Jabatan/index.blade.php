        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.status == 404) {
                    ...
                    $('#d_jabatan').text(response.jabatan.jabatan);
                    $('#d_keterangan').text(response.jabatan.keterangan);
                }
            }
        });
    });
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.status == 400) {
                    ...
                    setTimeout("window.location='{{ route('Jabatan.index') }}'", 1200);
                }
            }
        });
    });
...
<div class="my-4 page-header-breadcrumb d-flex align-items-center justify-content-between flex-wrap gap-2">
    <div>
        <h1 class="page-title fw-medium fs-18 mb-2">Jabatan</h1>
        <div class="">
            <nav>
            ...
            <div class="card-header justify-content-between">
                ...
                <div class="prism-toggle">
                    <a class="btn btn-primary btn-wave waves-effect waves-light"
                        ...
                        <i class="ri-add-line align-middle me-1 fw-medium"></i> Tambah Jabatan
                    </a>
                </div>
            </div>
            <div class="card-body">
                <table id="responsiveDataTable" class="table table-bordered text-nowrap w-100">
                    ...
                    <tbody>
                        @if (isset($jabatan) && count($jabatan) > 0)
...
<!-- Start:: Detail Jabatan -->
<div class="modal fade" id="detailModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title">Detail Jabatan</h6>
