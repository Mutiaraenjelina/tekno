        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.status == 404) {
                    ...
                    $('#d_namaRole').text(response.role.roleName);
                    $('#d_roleSlug').text(response.role.roleSlug);
                    $('#d_keterangan').text(response.role.description);
                }
            }
        });
    });
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.status == 400) {
                    ...
                    setTimeout("window.location='{{ route('Role.index') }}'", 1200);
                }
            }
        });
    });
        ...
        <div class="card custom-card">
            <div class="card-header justify-content-between">
                ...
                <div class="prism-toggle">
                    <a class="btn btn-primary btn-wave waves-effect waves-light" href="{{ route('Role.create') }}">
                        <i class="ri-add-line align-middle me-1 fw-medium"></i> Tambah Role
                    </a>
                </div>
            </div>
            <div class="card-body">
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end" style="">
                                                <li>
                                                    <button type="button" value="{{ $rl->id }}"
                                                ...
                                                <li><button type="button" value="{{ $rl->id }}"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title">Detail Role</h6>
            ...
            <div class="modal-body px-4">
                <div class="d-flex gap-3">
                    <div class="flex-fill">
                        ...
                        <span class="d-block fs-13 text-muted fw-normal" id="d_namaRole"></span>
                    </div>
                </div>
            </div>
            <div class="modal-body px-4">
                <div class="d-flex gap-3">
                    <div class="flex-fill">
                        <h6 class="mb-1 fs-13">Role Slug</h6>
                        <span class="d-block fs-13 text-muted fw-normal" id="d_roleSlug"></span>
                    </div>
                </div>
            </div>
            <div class="modal-body px-4">
...
<div class="modal fade" id="deleteModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title">Hapus Data Role</h6>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
