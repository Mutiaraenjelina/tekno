...
<div class="row">
    <div class="col-xl-12">
        ...
        <form class="row g-3 needs-validation" action="{{route('LokasiObjekRetribusi.store')}}" method="post" novalidate>
            {{ csrf_field() }}
            <div class="card custom-card">
                <div class="card-header justify-content-between">
                    <div class="card-title">
                        Tambah Lokasi Objek Retribusi
                    </div>
                </div>
                <div class="card-body">
                    <div class="mb-3">
                        <label for="validationCustom01" class="form-label">Lokasi Objek Retribusi</label>
                        <input type="text" class="form-control" id="validationCustom01" name="LokasiObjekRetribusi"
                            placeholder="Masukkan Lokasi Objek Retribusi" required>
