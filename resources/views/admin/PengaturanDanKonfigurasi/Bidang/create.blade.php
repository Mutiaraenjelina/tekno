...
<div class="row">
    <div class="col-xl-12">
        <form class="row g-3 needs-validation" action="{{ route('Bidang.store') }}" method="post" novalidate>
            {{ csrf_field() }}
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <select class="js-example-placeholder-single form-control" name="idDepartemen" required>
                            <option></option>
                            @foreach ($departemenCombo as $dpt)
                                <option value="{{ $dpt->idDepartemen }}">{{ $dpt->namaDepartmen }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="validationCustom01"
                            placeholder="Masukkan Parent Bidang" name="parentBidang" min="0" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="validationCustom01" name="namaBidang"
