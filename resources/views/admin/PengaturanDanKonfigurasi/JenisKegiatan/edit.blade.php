...
<div class="row">
    <div class="col-xl-12">
    @if (isset($kegiatan))
        <form action="{{ route('JenisKegiatan.update', $kegiatan -> idjenisKegiatan)}}" method="post" class="row g-3 needs-validation" novalidate>
        {{ csrf_field() }}
        <div class="card custom-card">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="validationCustom01" placeholder="Masukkan Jenis Kegiatan" name="jenisKegiatan" value="{{ $kegiatan -> jenisKegiatan }}" required>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="validationTextarea" placeholder="Masukkan Keterangan" rows="4" name="keterangan">{{ $kegiatan -> keterangan }}</textarea>
                    </div>
