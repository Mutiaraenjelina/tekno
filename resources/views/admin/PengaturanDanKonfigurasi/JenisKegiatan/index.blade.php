...
<script>
    ...
    $(document).on('click', '.detailBtn', function (e) {
        ...
        $.ajax({
            method: "GET",
            url: "{{ route('JenisKegiatan.detail') }}",
            data: {
                id: st_id
            },
            success: function (response) {
                if (response.status == 404) {
                    ...
                    $('#d_jenis_kegiatan').text(response.kegiatan.jenisKegiatan);
                    $('#d_keterangan').text(response.kegiatan.keterangan);
                }
            }
        });
    });
    ...
    $(document).on('click', '.delete_data', function (e) {
        ...
        $.ajax({
            type: "DELETE",
            url: "{{ route('JenisKegiatan.delete') }}",
            data: data,
            dataType: "json",
            success: function (response) {
                if (response.status == 400) {
                    ...
                    setTimeout("window.location='{{ route('JenisKegiatan.index') }}'", 1200);
                }
            }
        });
    });
...
<div class="my-4 page-header-breadcrumb d-flex align-items-center justify-content-between flex-wrap gap-2">
    <div>
        <h1 class="page-title fw-medium fs-18 mb-2">Jenis Kegiatan</h1>
        <div class="">
            <nav>
            ...
            <div class="card-header justify-content-between">
                ...
                <div class="prism-toggle">
                    <a class="btn btn-primary btn-wave waves-effect waves-light"
                        href="{{ route('JenisKegiatan.create') }}">
                        <i class="ri-add-line align-middle me-1 fw-medium"></i> Tambah Jenis Kegiatan
                    </a>
                </div>
            </div>
            <div class="card-body">
...
<!-- Start:: Detail Jenis Kegiatan -->
<div class="modal fade" id="detailModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title">Detail Jenis Kegiatan</h6>
...
<!-- End:: Detail Jenis Kegiatan -->

<!-- Start:: Delete Jenis Kegiatan-->
