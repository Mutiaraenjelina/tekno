...
<div class="row">
    <div class="col-xl-12">
        ...
        <form class="row g-3 needs-validation" action="{{route('JenisJangkaWaktu.store')}}" method="post" novalidate>
            {{ csrf_field() }}
            <div class="card custom-card">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="validationCustom01" name="jenisJangkaWaktu"
                            placeholder="Masukkan Perioditas" required>
