        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.status == 404) {
                    ...
                    $('#d_departemen').text(response.departemen.namaDepartmen);
                    $('#d_keterangan').text(response.departemen.keterangan);
                }
            }
        });
    });
