        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response.status == 404) {
                    ...
                    $('#d_jenis_dokumen').text(response.dokumenType.jenisDokumen);
                    $('#d_keterangan').text(response.dokumenType.keterangan);
                }
            }
        });
    });
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.status == 400) {
                    ...
                    setTimeout("window.location='{{ route('JenisDokumen.index') }}'", 1200);
                }
            }
        });
    });
        ...
        <div class="card custom-card">
            <div class="card-header justify-content-between">
                ...
                <div class="prism-toggle">
                    <a class="btn btn-primary btn-wave waves-effect waves-light" href="{{ route('JenisDokumen.create') }}">
                        <i class="ri-add-line align-middle me-1 fw-medium"></i> Tambah Jenis Dokumen
                    </a>
                </div>
            </div>
            <div class="card-body">
                <table id="responsiveDataTable" class="table table-bordered text-nowrap w-100">
                    ...
                    <tbody>
                        @if (isset($dokumenType) && count($dokumenType) > 0)
                            @foreach ($dokumenType as $st)
                                <tr>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li>
                                                    <button type="button" value="{{ $st->idJenisDokumen }}" class="dropdown-item detailBtn">
                                                        <i class="ri-eye-line me-1 align-middle d-inline-block"></i>Detail
                                                    </button>
                                                </li>
                                                <li><a class="dropdown-item" href="{{ route('JenisDokumen.edit', $st->idJenisDokumen) }}">
                                                    <i class="ri-edit-line me-1 align-middle d-inline-block"></i>Ubah</a>
                                                </li>
                                                <li><button type="button" value="{{ $st->idJenisDokumen }}" class="dropdown-item deleteBtn">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title">Detail Jenis Dokumen</h6>
