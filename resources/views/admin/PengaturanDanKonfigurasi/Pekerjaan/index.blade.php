            ...
            <div class="card-header justify-content-between">
                ...
                <div class="prism-toggle">
                    <a class="btn btn-primary btn-wave waves-effect waves-light"
                        href="{{ route('Pekerjaan.create') }}">
                        <i class="ri-add-line align-middle me-1 fw-medium"></i> Tambah Pekerjaan
                    </a>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <tbody>
                        @if (isset($pekerjaan) && count($pekerjaan) > 0)
                            @foreach ($pekerjaan as $pkj)
                                <tr>
                                    <td>{{ $pkj->namaPekerjaan }}</td>
                                    <td>{{ $pkj->keterangan }}</td>
                                    <td>
                                        <div class="dropdown">
