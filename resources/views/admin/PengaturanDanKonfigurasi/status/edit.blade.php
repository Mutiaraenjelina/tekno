        ...
        <div class="card custom-card">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <select class="js-example-placeholder-single form-control" name="jenisStatus" required>
                            ...
                            @foreach ($statusType as $sT)
                                <option value="{{$sT->idJenisStatus}}" {{ $sT->idJenisStatus === $status -> idJenisStatus ? 'selected' : '' }}>{{ $sT->jenisStatus }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="validationCustom01" placeholder="Masukkan Status" name="namaStatus"
                            value="{{ $status->namaStatus }}" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="validationTextarea" placeholder="Masukkan Keterangan" name="keterangan"
                            rows="4">{{ $status->keterangan }}</textarea>
                    </div>
